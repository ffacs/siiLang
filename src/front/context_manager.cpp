...
namespace front {
  FunctionSymbolPtr Symbol::NewFunctionSymbol( TypePtr                 type,
    ...
    return std::make_shared< FunctionSymbol >( std::move( type ),
                                               std::move( func ) );
  }
  ...
  public:
    ...
    void append_variable( const std::string& name,
                          SymbolPtr          variable ) override;
    void append_function( const std::string& name,
                          SymbolPtr          function ) override;
