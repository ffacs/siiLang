...
namespace SiiIR {
  ...
  public:
    virtual ~CodeBuilder() {}
    virtual SiiIRBinaryOperationPtr append_multiply( ValuePtr left,
                                                     ValuePtr right )
        = 0;
    virtual SiiIRBinaryOperationPtr append_divide( ValuePtr left,
                                                   ValuePtr right )
        = 0;
    virtual SiiIRBinaryOperationPtr append_add( ValuePtr left, ValuePtr right )
        = 0;
    virtual SiiIRBinaryOperationPtr append_sub( ValuePtr left, ValuePtr right )
        = 0;
    virtual SiiIRUnaryOperationPtr  append_neg( ValuePtr child ) = 0;
    virtual SiiIRBinaryOperationPtr append_equal( ValuePtr left,
                                                  ValuePtr right )
        = 0;
    ...
    virtual SiiIRBinaryOperationPtr append_less_equal( ValuePtr left,
                                                       ValuePtr right )
        = 0;
    virtual SiiIRConditionBranchPtr
    ...
    virtual SiiIRFunctionDefinitionPtr append_function( FunctionValuePtr left )
        = 0;
