...
public:
  virtual ~CodeBuilder() {}
  virtual void append_multiply(TemporaryValuePtr left, TemporaryValuePtr right,
                               TemporaryValuePtr result) = 0;
  virtual void append_divide(TemporaryValuePtr left, TemporaryValuePtr right,
                             TemporaryValuePtr result) = 0;
  ...
  virtual void append_equal(TemporaryValuePtr left, TemporaryValuePtr right,
                            TemporaryValuePtr result) = 0;
  virtual void append_not_equal(TemporaryValuePtr left, TemporaryValuePtr right,
                                TemporaryValuePtr result) = 0;
  virtual void append_less_than(TemporaryValuePtr left, TemporaryValuePtr right,
                                TemporaryValuePtr result) = 0;
  ...
  virtual void append_load(VariableValuePtr source, TemporaryValuePtr dest) = 0;
  virtual void append_return(TemporaryValuePtr value) = 0;
