...
public:
  virtual ~CodeBuilder() {}
  virtual void append_multiply(TemporaryAddressPtr left,
                               TemporaryAddressPtr right,
                               TemporaryAddressPtr result) = 0;
  virtual void append_divide(TemporaryAddressPtr left,
                             TemporaryAddressPtr right,
                             TemporaryAddressPtr result) = 0;
  ...
  virtual void append_sub(TemporaryAddressPtr left, TemporaryAddressPtr right,
                          TemporaryAddressPtr result) = 0;
  virtual void append_neg(TemporaryAddressPtr child,
                          TemporaryAddressPtr result) = 0;
  virtual void append_equal(TemporaryAddressPtr left, TemporaryAddressPtr right,
                            TemporaryAddressPtr result) = 0;
  virtual void append_not_equal(TemporaryAddressPtr left,
                                TemporaryAddressPtr right,
                                TemporaryAddressPtr result) = 0;
  virtual void append_less_than(TemporaryAddressPtr left,
                                TemporaryAddressPtr right,
                                TemporaryAddressPtr result) = 0;
  virtual void append_less_equal(TemporaryAddressPtr left,
                                 TemporaryAddressPtr right,
                                 TemporaryAddressPtr result) = 0;
  virtual void append_condition_branch(TemporaryAddressPtr expression,
                                       LabelPtr true_label,
                                       LabelPtr false_label) = 0;
  virtual void append_goto(LabelPtr label) = 0;
  virtual std::pair<LabelFuturePtr, LabelFuturePtr>
  append_condition_branch(TemporaryAddressPtr expression) = 0;
  ...
  virtual void append_load(VariableAddressPtr source,
