...
namespace front {
  ...
  TEST( Type, NormalizePointerType ) {
    EXPECT_EQ( *Type::NormalizePointer(
                   Type::Pointer( Type::Basic( TypeKind::INT ) ) ),
               *Type::NormalizePointer(
                   Type::Pointer( Type::Basic( TypeKind::INT ) ) ) );

    EXPECT_EQ( *Type::NormalizePointer(
                   Type::Pointer( Type::Basic( TypeKind::INT ), 10 ) ),
               *Type::NormalizePointer(
                   Type::Pointer( Type::Basic( TypeKind::INT ), 10 ) ) );
  }
  ...
  TEST( Type, NormalizeArrayType ) {
    ...
    EXPECT_NO_THROW( Type::NormalizeArrayType(
        Type::Array( Type::Array( Type::Basic( TypeKind::INT ), 1 ), 1 ),
        true ) );

    EXPECT_THROW(
        Type::NormalizeArrayType(
            Type::Array( Type::Function( Type::Basic( TypeKind::INT ), {} ),
                         1 ),
            false ),
        std::invalid_argument );
  }
  ...
  TEST( Type, NormalizeParameterDeclaration ) {
    ...
    EXPECT_THROW( Type::NormalizeParameterDeclaration( Type::Array(
                      Type::Array( Type::Basic( TypeKind::INT ),
                                   ArrayType::ELEMENT_COUNT_UNKOWN ),
                      ArrayType::ELEMENT_COUNT_UNKOWN ) ),
                  std::invalid_argument );
  ...
  TEST( Type, NormalizeVariableDeclaration ) {
    ...
    EXPECT_THROW( Type::NormalizeVariableDeclaration( Type::Array(
                      Type::Array( Type::Basic( TypeKind::INT ),
                                   ArrayType::ELEMENT_COUNT_UNKOWN ),
                      ArrayType::ELEMENT_COUNT_UNKOWN ) ),
                  std::invalid_argument );
