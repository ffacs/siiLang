...
namespace front {
  ...
  TEST( Parser, ArithmeticMulAndDiv ) {
    ...
    EXPECT_EQ( ASTToString( CreateParser( case2 )->parse_compound_statement() ),
               ASTToString( ASTNode::Compound_statement(
                   { ASTNode::Multiply( ASTNode::Integer( "1" ),
                                        ASTNode::Integer( "2" ) ),
  ...
  TEST( Parser, ArithmeticAddAndSub ) {
    ...
    EXPECT_EQ( ASTToString( CreateParser( case5 )->parse_compound_statement() ),
               ASTToString( ASTNode::Compound_statement(
                   { ASTNode::Add( ASTNode::Subtract( ASTNode::Integer( "1" ),
                                                      ASTNode::Integer( "2" ) ),
                                   ASTNode::Integer( "3" ) ) } ) ) );
  ...
  TEST( Parser, ArithmeticRelation ) {
    ...
    EXPECT_EQ( ASTToString( CreateParser( case5 )->parse_compound_statement() ),
               ASTToString( ASTNode::Compound_statement( { ASTNode::Less_equal(
                   ASTNode::Less_than( ASTNode::Integer( "1" ),
                                       ASTNode::Integer( "2" ) ),
                   ASTNode::Integer( "2" ) ) } ) ) );
  }
  ...
  TEST( Parser, Assignment ) {
    EXPECT_EQ( ASTToString(
               ...
               ASTToString( ASTNode::Compound_statement( { ASTNode::Assign(
                   ASTNode::Integer( "1" ),
                   ASTNode::Assign( ASTNode::Integer( "2" ),
                                    ASTNode::Integer( "3" ) ) ) } ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "{1 == 2 = var2 = 3 + var3;}" )
  ...
  TEST( Parser, CompoundStatement ) {
    EXPECT_EQ(
        ASTToString( CreateParser( "{ {var1;} {{var2;}} {} }" )
                         ->parse_compound_statement() ),
        ASTToString( ASTNode::Compound_statement(
            { ASTNode::Compound_statement( { ASTNode::Identifier( "var1" ) } ),
              ASTNode::Compound_statement( { ASTNode::Compound_statement(
                  { ASTNode::Identifier( "var2" ) } ) } ),
              ASTNode::Compound_statement( {} ) } ) ) );
  }

  TEST( Parser, SelectStatement ) {
    EXPECT_EQ( ASTToString( CreateParser( "{if(var1) { var1 = 1;}}" )
                                ->parse_compound_statement() ),
               ASTToString( ASTNode::Compound_statement( { ASTNode::If_else(
                   ...
                   nullptr ) } ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "{if(var1) { var1 = 1;} else {var1=2;}}" )
                         ->parse_compound_statement() ),
        ASTToString( ASTNode::Compound_statement( { ASTNode::If_else(
            ASTNode::Identifier( "var1" ),
            ASTNode::Compound_statement( {
    ...
    EXPECT_EQ(
        ...
        ASTToString( ASTNode::Compound_statement( { ASTNode::If_else(
            ...
            ASTNode::If_else( ASTNode::Identifier( "var2" ),
  ...
  TEST( Parser, IterationStatement ) {
    EXPECT_EQ( ASTToString(
               ...
               ASTToString( ASTNode::Compound_statement( { ASTNode::For_loop(
                   ...
                   ASTNode::empty(),
                   ASTNode::Compound_statement( {} ) ) } ) ) );
    EXPECT_EQ( ASTToString( CreateParser( "{for(var1;var2;var3) {}}" )
                                ->parse_compound_statement() ),
               ASTToString( ASTNode::Compound_statement( { ASTNode::For_loop(
                   ASTNode::Identifier( "var1" ),
                   ASTNode::Identifier( "var2" ),
                   ...
                   ASTNode::Compound_statement( {} ) ) } ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "{for(var1; var2; var3) { var1 = 3; } }" )
                         ->parse_compound_statement() ),
        ASTToString( ASTNode::Compound_statement(
            { ASTNode::For_loop( ASTNode::Identifier( "var1" ),
                                 ASTNode::Identifier( "var2" ),
                                 ASTNode::Identifier( "var3" ),
                                 ASTNode::Compound_statement( { ASTNode::Assign(
                                     ASTNode::Identifier( "var1" ),
    ...
    EXPECT_EQ( ASTToString( CreateParser( "{while(var1) { var1 = 3; }}" )
               ...
               ASTToString( ASTNode::Compound_statement( { ASTNode::While_loop(
                   ...
                   ASTNode::Compound_statement( { ASTNode::Assign(
                       ...
                       ASTNode::Integer( "3" ) ) } ) ) } ) ) );
    EXPECT_ANY_THROW(
        CreateParser( "{while() {}}" )->parse_compound_statement() );
    EXPECT_EQ(
        ASTToString( CreateParser( "{do {var1 = 3;} while(var1);}" )
                         ->parse_compound_statement() ),
        ASTToString( ASTNode::Compound_statement( { ASTNode::Do_while(
            ASTNode::Compound_statement( { ASTNode::Assign(
                ASTNode::Identifier( "var1" ), ASTNode::Integer( "3" ) ) } ),
            ASTNode::Identifier( "var1" ) ) } ) ) );
    EXPECT_EQ( ASTToString( CreateParser( "{do ; while(var1 = 3);}" )
                                ->parse_compound_statement() ),
               ASTToString( ASTNode::Compound_statement( { ASTNode::Do_while(
                   ASTNode::empty(),
                   ASTNode::Assign( ASTNode::Identifier( "var1" ),
    ...
    EXPECT_ANY_THROW(
        CreateParser( "{do ;while();}" )->parse_compound_statement() );
    EXPECT_ANY_THROW(
        CreateParser( "{do ;while()}" )->parse_compound_statement() );
  }
  TEST( Parser, Declaration ) {
    ...
    EXPECT_EQ(
        ...
        ASTToString( ASTNode::Compound_statement(
            { ASTNode::Declaration_statement( { ASTNode::Function_declaration(
                ...
                nullptr ) } ) } ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "{int a(int b, int* c);}" )
                         ->parse_compound_statement() ),
        ASTToString( ASTNode::Compound_statement(
            { ASTNode::Declaration_statement( { ASTNode::Function_declaration(
                Declarator::Create(
    ...
    EXPECT_EQ(
        ...
        ASTToString( ASTNode::Compound_statement(
            { ASTNode::Declaration_statement( { ASTNode::Variable_declaration(
                Declarator::Create(
                    Type::Array( Type::Basic( TypeKind::INT ), 2 ), "a" ),
                nullptr ) } ) } ) ) );
    EXPECT_EQ(
        ASTToString(
    ...
    EXPECT_EQ(
        ...
        ASTToString( ASTNode::Compound_statement(
            { ASTNode::Declaration_statement( { ASTNode::Declaration(
                Declarator::Create( Type::Array( Type::Pointer( Type::Function(
                                                     Type::Pointer( Type::Basic(
                                                         TypeKind::INT ) ),
                                                     {} ) ),
                                                 4 ),
    ...
    EXPECT_EQ(
        ...
        ASTToString(
            ASTNode::Compound_statement( { ASTNode::Declaration_statement(
                { ASTNode::Declaration(
                      Declarator::Create( Type::Pointer( Type::Pointer(
                                              Type::Basic( TypeKind::INT ) ) ),
                                          "a" ),
                      nullptr ),
                  ASTNode::Declaration(
    ...
    EXPECT_EQ(
        ...
        ASTToString(
            ASTNode::Compound_statement( { ASTNode::Declaration_statement(
                { ASTNode::Declaration(
                      Declarator::Create(
                          Type::Array( Type::Basic( TypeKind::INT ), 4 ), "a" ),
                      nullptr ),
                  ASTNode::Declaration(
                      Declarator::Create(
                          Type::Pointer( Type::Basic( TypeKind::INT ) ), "b" ),
        ...
        ASTToString(
            ASTNode::Compound_statement( { ASTNode::Declaration_statement(
                { ASTNode::Declaration(
                      Declarator::Create(
                          Type::Array(
                              Type::Array( Type::Basic( TypeKind::INT ), 3 ),
                              4 ),
                          "a" ),
                      nullptr ),
                  ASTNode::Declaration(
    ...
    EXPECT_EQ(
        ...
        ASTToString(
            ASTNode::Compound_statement( { ASTNode::Declaration_statement(
                { ASTNode::Declaration(
                      Declarator::Create(
                          Type::Array( Type::Array( Type::Pointer( Type::Basic(
                                                        TypeKind::INT ) ),
                                                    3 ),
                                       4 ),
                          "a" ),
                  ...
                  ASTNode::Declaration(
                      ...
                      nullptr ) } ) } ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "{int (*a)[4][3], *b;}" )
                         ->parse_compound_statement() ),
        ASTToString(
            ASTNode::Compound_statement( { ASTNode::Declaration_statement(
                { ASTNode::Declaration(
            ...
            ASTNode::Compound_statement( { ASTNode::Declaration_statement(
                { ASTNode::Declaration(
                  ...
                  ASTNode::Declaration(
                      ...
                      nullptr ) } ) } ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "{int *(*a[4])(), *b;}" )
                         ->parse_compound_statement() ),
        ASTToString(
            ASTNode::Compound_statement( { ASTNode::Declaration_statement(
                { ASTNode::Declaration(
                  ...
                  ASTNode::Declaration(
                      ...
                      nullptr ) } ) } ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "{int *a = c = b + 10;}" )
                         ->parse_compound_statement() ),
        ASTToString(
            ASTNode::Compound_statement( { ASTNode::Declaration_statement( {
              ASTNode::Declaration(
  ...
  TEST( Parser, DeclarationOrFunctionDefinition ) {
    ...
    EXPECT_THROW( CreateParser( "int x(y, int z) int y;" )
                      ->parse_declaration_or_function_definition(),
                  std::invalid_argument );
    EXPECT_THROW( CreateParser( "int x()();" )
                      ->parse_declaration_or_function_definition(),
                  std::invalid_argument );
    EXPECT_THROW( CreateParser( "int x()[];" )
                      ->parse_declaration_or_function_definition(),
                  std::invalid_argument );
    EXPECT_THROW( CreateParser( "int x()[5];" )
                      ->parse_declaration_or_function_definition(),
                  std::invalid_argument );
    EXPECT_EQ( ASTToString( CreateParser( "int;" )
                                ->parse_declaration_or_function_definition() ),
               ASTToString( ASTNode::Declaration_statement( {} ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "int a;" )
                         ->parse_declaration_or_function_definition() ),
    ...
    EXPECT_EQ(
        ...
        ASTToString( ASTNode::Declaration_statement( { ASTNode::Declaration(
            ...
            nullptr ) } ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "int a = b;" )
                         ->parse_declaration_or_function_definition() ),
        ASTToString( ASTNode::Declaration_statement( { ASTNode::Declaration(
            Declarator::Create( Type::Basic( TypeKind::INT ), "a" ),
            ASTNode::Identifier( "b" ) ) } ) ) );
    EXPECT_EQ( ASTToString( CreateParser( "int a, *b, c = a = 10;" )
                                ->parse_declaration_or_function_definition() ),
               ASTToString( ASTNode::Declaration_statement( {
                 ASTNode::Declaration(
                     Declarator::Create( Type::Basic( TypeKind::INT ), "a" ),
        ...
        ASTToString( ASTNode::Function_declaration(
            ...
            ASTNode::Compound_statement(
                { ASTNode::Declaration_statement( { ASTNode::Declaration(
                    ...
                    ASTNode::Identifier( "y" ) ) } ) } ) ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "int a(int i, int j);" )
                         ->parse_declaration_or_function_definition() ),
        ASTToString( ASTNode::Declaration_statement( { ASTNode::Declaration(
            Declarator::Create(
                Type::Function(
    ...
    EXPECT_EQ(
        ...
        ASTToString( ASTNode::Declaration_statement( { ASTNode::Declaration(
            ...
            nullptr ) } ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "int a(i, j);" )
                         ->parse_declaration_or_function_definition() ),
        ASTToString( ASTNode::Declaration_statement( { ASTNode::Declaration(
            Declarator::Create(
                Type::Function(
            ...
            nullptr ) } ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "int a(i, j, k) int k; {}" )
                         ->parse_declaration_or_function_definition() ),
        ASTToString( ASTNode::Function_declaration(
            Declarator::Create(
                Type::Function(
        ...
        ASTToString( ASTNode::Function_declaration(
            ...
            ASTNode::Compound_statement(
                { ASTNode::Declaration_statement( { ASTNode::Declaration(
                    ...
                    ASTNode::Identifier( "y" ) ) } ) } ) ) ) );
    EXPECT_EQ(
        ASTToString( CreateParser( "int* a(int i, int j) { int x = y; }" )
                         ->parse_declaration_or_function_definition() ),
        ASTToString( ASTNode::Function_declaration(
            Declarator::Create(
                Type::Function(
  ...
  TEST( Parser, GetValue ) {
    EXPECT_EQ(
        ASTToString( CreateParser( "&a;" )->parse_assignment() ),
        ASTToString( ASTNode::Get_address( ASTNode::Identifier( "a" ) ) ) );
  }

  TEST( Parser, Return ) {
    EXPECT_EQ(
        ASTToString( CreateParser( "return a;" )->parse_jump_statement() ),
        ASTToString( ASTNode::Return( ASTNode::Identifier( "a" ) ) ) );

    EXPECT_THROW(
        ASTToString( CreateParser( "int main() { return; }" )
                         ->parse_declaration_or_function_definition() ),
        std::invalid_argument );
  }
