...
TEST(Parser, Assignment) {
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{1 == 2 = var2 = 3 + var3;}")->parse_compound_statement()),
    ASTToString(ASTNode::compound_statement({
      ASTNode::assign(
        ASTNode::equal(
          ASTNode::integer("1"), 
...
TEST(Parser, CompoundStatement) {
  EXPECT_EQ(
    ASTToString(CreateParser("{ {var1;} {{var2;}} {} }")->parse_compound_statement()),
    ASTToString(ASTNode::compound_statement({
...
TEST(Parser, SelectStatement) {
  EXPECT_EQ(
    ASTToString(CreateParser("{if(var1) { var1 = 1;}}")->parse_compound_statement()),
    ASTToString(ASTNode::compound_statement({
      ASTNode::if_else(
        ASTNode::identifier("var1"),
        ASTNode::compound_statement({
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{if(var1) { var1 = 1;} else {var1=2;}}")->parse_compound_statement()),
    ASTToString(ASTNode::compound_statement({
      ASTNode::if_else(
        ASTNode::identifier("var1"),
        ASTNode::compound_statement({
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{if(var1) { var1 = 1;} else if (var2) {var2=2;} else {var1 = 3;}}")->parse_compound_statement()),
    ASTToString(ASTNode::compound_statement({
      ASTNode::if_else(
        ASTNode::identifier("var1"),
        ASTNode::compound_statement({
...
TEST(Parser, IterationStatement) {
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{for(var1;var2;var3) {}}")->parse_compound_statement()),
    ASTToString(ASTNode::compound_statement({
      ASTNode::for_loop(
        ASTNode::identifier("var1"),
        ASTNode::identifier("var2"),
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{for(var1; var2; var3) { var1 = 3; } }")->parse_compound_statement()),
    ASTToString(ASTNode::compound_statement({
      ASTNode::for_loop(
        ASTNode::identifier("var1"),
        ASTNode::identifier("var2"),
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{while(var1) { var1 = 3; }}")->parse_compound_statement()),
    ASTToString(ASTNode::compound_statement({
      ASTNode::while_loop(
        ASTNode::identifier("var1"),
        ASTNode::compound_statement({
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{do {var1 = 3;} while(var1);}")->parse_compound_statement()),
    ASTToString(ASTNode::compound_statement({
      ASTNode::do_while(
        ASTNode::compound_statement({
          ASTNode::assign(ASTNode::identifier("var1"), ASTNode::integer("3"))
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{do ; while(var1 = 3);}")->parse_compound_statement()),
    ASTToString(ASTNode::compound_statement({
      ASTNode::do_while(
        ASTNode::empty(),
        ASTNode::assign(ASTNode::identifier("var1"), ASTNode::integer("3")))
...
TEST(Parser, Declaration) {
  ...
  EXPECT_THROW(CreateParser("{int a[2]();}")->parse_compound_statement(), std::invalid_argument);
  EXPECT_EQ(
    ASTToString(CreateParser("{int ;}")->parse_compound_statement()), 
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{int a(int b, int* c);}")->parse_compound_statement()), 
    ASTToString(ASTNode::compound_statement({
      ASTNode::declaration_statement({
        ASTNode::function_declaration(
          Declarator::Create(
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{int a(int b[2]);}")->parse_compound_statement()), 
    ASTToString(ASTNode::compound_statement({
      ASTNode::declaration_statement({
        ASTNode::function_declaration(
          Declarator::Create(
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{int a(int b());}")->parse_compound_statement()), 
    ASTToString(ASTNode::compound_statement({
      ASTNode::declaration_statement({
        ASTNode::function_declaration(
          Declarator::Create(
        ...
        ASTNode::function_declaration(
          Declarator::Create(
            Type::function(Type::basic(TypeKind::INT), 
            {
              Declarator::Create(Type::pointer(Type::function(Type::basic(TypeKind::INT), 
              {
                Declarator::Create(Type::pointer(Type::function(Type::basic(TypeKind::INT), {})), "c") 
              })), "b"),
            }), "a"),
          nullptr)
      })
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{int *(*a[4])();}")->parse_compound_statement()), 
    ASTToString(ASTNode::compound_statement({
      ASTNode::declaration_statement({
        ASTNode::declaration(
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{int a[4][3], *b;}")->parse_compound_statement()), 
    ASTToString(ASTNode::compound_statement({
      ASTNode::declaration_statement({
        ASTNode::declaration(
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("{int *a = c = b + 10;}")->parse_compound_statement()), 
    ASTToString(ASTNode::compound_statement({
      ASTNode::declaration_statement({
        ASTNode::declaration(
          Declarator::Create(Type::pointer(Type::basic(TypeKind::INT)), "a"),
...
TEST(Parser, DeclarationOrFunctionDefinition) {
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("int;")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::declaration_statement({}))
  );
  EXPECT_EQ(
    ASTToString(CreateParser("int a;")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::declaration_statement({
      ASTNode::declaration(Declarator::Create(Type::basic(TypeKind::INT), "a"), nullptr)
    }))
  );
  EXPECT_EQ(
    ASTToString(CreateParser("int a[4];")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::declaration_statement({
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("int a = b;")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::declaration_statement({
      ASTNode::declaration(Declarator::Create(Type::basic(TypeKind::INT), "a"), ASTNode::identifier("b"))
    }))
  );
  EXPECT_EQ(
    ASTToString(CreateParser("int a, *b, c = a = 10;")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::declaration_statement({
      ASTNode::declaration(Declarator::Create(Type::basic(TypeKind::INT), "a"), nullptr),
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("int a = 10, *b, c = a = 10;")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::declaration_statement({
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("a() {}")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::function_declaration(
        Declarator::Create(Type::function(Type::basic(TypeKind::INT), {}), "a"), 
        {},
        ASTNode::compound_statement({})
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("int* a() { int x = y; }")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::function_declaration(
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("int a(int i, int j);")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::declaration_statement({
      ASTNode::declaration(
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("int a(int i(), int j[5]);")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::declaration_statement({
      ASTNode::declaration(
        Declarator::Create(Type::function(Type::basic(TypeKind::INT), 
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("int a(i, j);")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::declaration_statement({
      ASTNode::declaration(
        Declarator::Create(Type::function(Type::basic(TypeKind::INT), 
                                          { Declarator::Create(Type::basic(TypeKind::INT), "i"),
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("int a(i, j, k) int k; {}")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::function_declaration(
       Declarator::Create(Type::function(Type::basic(TypeKind::INT), 
                                         { Declarator::Create(Type::basic(TypeKind::INT), "i"),
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("int* a(i, j) int i; int j; { int x = y; }")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::function_declaration(
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("int* a(int i, int j) { int x = y; }")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::function_declaration(
      Declarator::Create(Type::function(Type::pointer(Type::basic(TypeKind::INT)), 
                                        { Declarator::Create(Type::basic(TypeKind::INT), "i"),
                                          Declarator::Create(Type::basic(TypeKind::INT), "j"), }), "a"),
  ...
  EXPECT_EQ(
    ASTToString(CreateParser("int a(int (*i)(int, int), int j) { int x = y; }")->parse_declaration_or_function_definition()), 
    ASTToString(ASTNode::function_declaration(
      Declarator::Create(Type::function(Type::basic(TypeKind::INT),
                                        { Declarator::Create(Type::pointer(Type::function(Type::basic(TypeKind::INT), 
