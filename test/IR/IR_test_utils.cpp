...
namespace SiiIR {
FunctionPtr BuildFunction(size_t node_count, size_t extra_edge_count,
                          bool random) {
...
static void TraverseWithout(BasicGroup *current, BasicGroup *without,
...
static std::set<BasicGroup *> DeleteAndTest(FunctionPtr func,
                                            BasicGroup *node) {
  std::set<BasicGroup *> visited;
